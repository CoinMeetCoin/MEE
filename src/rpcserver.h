...
extern json_spirit::Value getposinfo(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value clearrawmempool(const json_spirit::Array& params, bool fHelp);
