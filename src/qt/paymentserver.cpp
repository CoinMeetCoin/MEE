...
const QString BITCOIN_IPC_PREFIX("MEE:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click MEE: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start MEE: click-to-pay handler");
    else
...
{
    // clicking on MEE: URLs creates FileOpen events on the Mac:
